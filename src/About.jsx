  ...
  return (
    <div style={{margin:"1rem auto"}}>
      <div className="about-box">
        ...
        <h4>
          Follow us on Instagram to stay updated with our latest creations, design processes and sketches.
        </h4>
      </div>
      <div className="img-store">
        ...
        <img src="https://www.sapphirestudiosdesign.com/wp-content/uploads/2023/04/Shop-SSD-02-768x1024.jpg" alt="" />
      </div>
    </div>
  )
}
